...
if (typeof window.TurnstileWidget === 'undefined') {
    window.TurnstileWidget = class {
        ...
        #renderTurnstile(element) {
            ...
            var widgetId;
            var url = turnstileConfigData.properties["fd:captcha"].config.uri;
            ...
            var hparameters = {
                'sitekey': turnstileConfigData.properties["fd:captcha"].config.siteKey,
                'size': turnstileConfigData.properties["fd:captcha"].config.size,
                'theme': turnstileConfigData.properties["fd:captcha"].config.theme || 'light',
